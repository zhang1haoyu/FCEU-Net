...
def parse_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='fecunet', type=str)
    parser.add_argument('--batch_size', default=1, type=int)#48
    ...
    parser.add_argument('--root', default=r'./Vaihingen', type=str,
                        help='dataset path')
...
def main():
    ...
    # criterion
    criterion = CriterionSet(loss='cross_entropy')#cross_entropy  #EdgeLoss
